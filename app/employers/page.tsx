...
const talentPool = [
  ...
  { rank: 2, name: "Arjuna Sharma", college: "IIT Bombay", score: 94, skills: { coding: 92, speaking: 89, logical: 96, personality: 91 }, experience: "Experienced", location: "Mumbai, Maharashtra", availability: "Available", roleMatch: 95, isSpotlight: true },
